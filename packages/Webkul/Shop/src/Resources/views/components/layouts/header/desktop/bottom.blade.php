...
@php
    $isGalleryPage = request()->is('page/gallery');

    $isAboutUsPage = request()->is('page/about-us');
@endphp
...
<div class="flex min-h-[78px] w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8">
    ...
    <div class="flex items-center gap-x-9 max-[1100px]:gap-x-6 max-lg:gap-x-8">
        <div class="{{ $isGalleryPage ? 'border-navyBlue' : 'border-transparent hover:border-b-4 hover:border-navyBlue' }} group relative flex h-[77px] items-center border-b-4">
            <span>
                <a
                    href="{{ url('page/gallery') }}"
                    class="{{ $isGalleryPage ? 'text-navyBlue' : '' }} inline-block px-5 uppercase"
                    @if ($isGalleryPage)
                        aria-current="page"
                    @endif
                >
        ...
        <div class="{{ $isAboutUsPage ? 'border-navyBlue' : 'border-transparent hover:border-b-4 hover:border-navyBlue' }} group relative flex h-[77px] items-center border-b-4">
            <span>
                <a
                    href="{{ url('page/about-us') }}"
                    class="{{ $isAboutUsPage ? 'text-navyBlue' : '' }} inline-block px-5 uppercase"
                    @if ($isAboutUsPage)
                        aria-current="page"
                    @endif
                >
