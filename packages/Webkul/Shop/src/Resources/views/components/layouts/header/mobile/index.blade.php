...
<div class="flex flex-wrap gap-4 px-4 pt-6 pb-4 shadow-sm lg:hidden">
    ...
    <div class="flex w-full items-center gap-3">
        <a
            ...
            class="{{ $isAboutUsPage ? 'border-b-2 border-navyBlue text-navyBlue' : 'border-b-2 border-transparent text-zinc-700 hover:border-navyBlue hover:text-navyBlue' }} whitespace-nowrap pb-1 text-sm font-medium transition-colors"
            @if ($isAboutUsPage)
                aria-current="page"
            @endif
        >
