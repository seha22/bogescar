...
it('displays the "Tentang Kami" navigation link in desktop header', function () {
    // Act
    $response = get(route('shop.home.index'));
    ...
    expect(Str::contains($response->content(), 'Tentang Kami'))
        ->toBeTruthy();

    expect(Str::contains($response->content(), 'page/about-us'))
        ->toBeTruthy();
});

it('displays the "Gallery" navigation link in desktop header', function () {
    // Act
    $response = get(route('shop.home.index'));
    ...
    expect(Str::contains($response->content(), 'GALLERY'))
        ->toBeTruthy();

    expect(Str::contains($response->content(), 'page/gallery'))
        ->toBeTruthy();
});

it('marks "Tentang Kami" as active on about us page', function () {
    // Act
    $response = get(url('page/about-us'));
    ...
    expect(Str::contains($response->content(), 'aria-current="page"'))
        ->toBeTruthy();
});
